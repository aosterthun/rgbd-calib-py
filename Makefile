...
default: $(TARGET)
	...
	c++ -std=c++11 examples/kinect_client.o src/Event.o src/KinectDaemon.o src/KinectDaemonHandshake.o src/Observable.o src/PlayCommand.o src/Threadable.o src/ZMQMessageType.o src/ThreadEvent.o src/EventData.o src/GenericMessage.o -o examples/kinect_client -lboost_system -lboost_serialization -lzmq -pthread
