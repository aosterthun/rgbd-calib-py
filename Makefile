...
default: $(TARGET)
	...
	c++ -std=c++11 examples/kinect_client.o src/Event.o src/KinectDaemon.o src/KinectDaemonHandshake.o src/Threadable.o src/ZMQMessageType.o -o examples/kinect_client -lboost_system -lboost_serialization -lzmq
