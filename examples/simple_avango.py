...
def start():
    ...
    video_loader = avango.gua.nodes.Video3DLoader()
    video_node = avango.gua.nodes.TransformNode()
    video = video_loader.load("kinect", "/home/mejo6715/Hiwi/kinect_recordings/surface_23_24_25_26.ks")
    video_node.Children.value.append(video)
